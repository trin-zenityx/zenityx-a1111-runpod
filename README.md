...
- Release: <https://github.com/trin-zenityx/zenityx-a1111-runpod/releases/tag/v0.1.6>

```text
ghcr.io/trin-zenityx/zenityx-a1111-runpod:0.1.6
```
...
- ตรึง MediaPipe `0.10.11` เพื่อคง Legacy Solutions API ที่ ControlNet `v1.1.455` ใช้ และให้เข้ากับ protobuf `3.20.0` ของ A1111
...
docker buildx build \
  ...
  -t YOUR_DOCKERHUB_USER/zenityx-a1111:0.1.6 \
  --push .
```
