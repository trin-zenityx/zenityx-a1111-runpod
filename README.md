...
- Release: <https://github.com/trin-zenityx/zenityx-a1111-runpod/releases/tag/v0.1.5>

```text
ghcr.io/trin-zenityx/zenityx-a1111-runpod:0.1.5
```

Verified linux/amd64 image digest:

```text
sha256:ba807df53c24f8a80f08fa0bc1419f7cc0ac51342abeae5d296797c30e26cdb4
```
...
- ตรึง MediaPipe `0.10.21` เพื่อคง Legacy Solutions API ที่ ControlNet `v1.1.455` ใช้สร้างหน้า UI
...
docker buildx build \
  ...
  -t YOUR_DOCKERHUB_USER/zenityx-a1111:0.1.5 \
  --push .
```
